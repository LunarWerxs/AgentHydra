...
- **Unified session browser (Claude, Codex, OpenCode, Hermes)** - Browse, filter (provider/project/recency), search and live-tail Claude Code, Codex, OpenCode and Hermes Agent transcripts together in one list, newest first. - `server/src/sessions.ts:832`, `server/src/sessions.ts:1185`
