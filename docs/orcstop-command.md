---
description: Stop the orchestrator on this thread - no prompts until /orcstart
---

Mark THIS session as parked for the AgentHydra orchestrator, then stop.
